...
namespace API.Migrations
{
    ...
    [Migration("20220705181710_202207051816")]
    partial class _202207051816
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.PayableAt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Entities.Product", b =>
                {
                    ...
                    b.Property<bool>("IsByLevel")
                        .HasColumnType("bit");

                    b.Property<bool>("IsByZone")
                        .HasColumnType("bit");

                    b.Property<bool>("IsPaidCash")
                        .HasColumnType("bit");

                    b.Property<bool>("IsPctOrAmount")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("API.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("ForgotPasswordDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("NextRegCreated")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("API.Entities.FinOp", b =>
                {
                    ...
                    b.HasOne("API.Entities.User", "ForUser")
                        .WithMany()
                    ...
                    b.HasOne("API.Entities.User", "InsertUser")
                        .WithMany()
                    ...
                    b.HasOne("API.Entities.User", "UpdateUser")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Entities.Order", b =>
                {
                    ...
                    b.HasOne("API.Entities.User", "Child")
                        .WithMany()
                        .HasForeignKey("ChildId");

                    b.HasOne("API.Entities.User", "Father")
                        .WithMany()
                        .HasForeignKey("FatherId");

                    b.HasOne("API.Entities.User", "Mother")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Entities.Product", b =>
                {
                    b.HasOne("API.Entities.PayableAt", "PayableAt")
                        .WithMany()
                        .HasForeignKey("PayableAtId");

                    b.HasOne("API.Entities.Periodicity", "Periodicity")
                        .WithMany()
                        .HasForeignKey("PeriodicityId");

                    b.HasOne("API.Entities.Product", "ProductP")
                        .WithMany()
                    ...
                    b.HasOne("API.Entities.RegFeeType", "RegFeeType")
                        .WithMany()
                        .HasForeignKey("RegFeeTypeId");

                    b.Navigation("PayableAt");

                    b.Navigation("Periodicity");

                    b.Navigation("ProductP");

                    b.Navigation("ProductType");

                    b.Navigation("RegFeeType");
                });
